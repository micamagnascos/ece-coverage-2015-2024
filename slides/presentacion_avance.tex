...
\begin{itemize}
  ...
  \item \textbf{Unidad de análisis}: unidad vecinal (UV) --- subdivisión territorial de una comuna. El MDS la usa para sectorizar el país, focalizar beneficios estatales y analizar datos del RSH; ofrece mayor desagregación que la literatura comparada.
  \item \textbf{Tratamiento}: una UV se considera tratada desde el año en que se inaugura el primer jardín infantil público dentro de su territorio o en una UV contigua$^{*}$.
...
\node[box, below=5pt of b1] (b2) {\textbf{2. Asignación espacial jardín $\to$ UV} (Python / GeoPandas) \\ \scriptsize shapefile de unidades vecinales (MDSF, 6.877 UVs) + \texttt{sjoin} espacial};
...
\begin{center}
\includegraphics[width=0.8\textwidth,height=0.64\textheight,keepaspectratio]{../jardines_rm.jpeg}
\end{center}
...
\begin{itemize}
  ...
  \item \textbf{Muestra exacta}: qué rango de edad y qué mujeres incluir en el panel, para fertilidad y para mercado laboral por separado.
\end{itemize}
\end{block}
\end{frame}
